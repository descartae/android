...
import kotlinx.android.synthetic.main.time_item.view.day
import kotlinx.android.synthetic.main.time_item.view.time
import org.descartae.android.FacilityQuery
import org.descartae.android.R
import org.descartae.android.view.viewholder.ListTimeViewHolder

class OpenHourListAdapter(
  private val mContext: Context) : RecyclerView.Adapter<ListTimeViewHolder>() {
  ...
  override fun onBindViewHolder(holder: ListTimeViewHolder, position: Int) {
    ...
    openHourList.let {
      ...
      openHour.let {
        ...
        holder.itemView.time.text = mContext.getString(R.string.time_desc, it?.startTime(),
            it?.endTime())
      }
    }
  }
