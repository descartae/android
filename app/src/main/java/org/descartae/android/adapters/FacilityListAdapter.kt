...
class FacilityListAdapter(
  private val mListener: (FacilitiesQuery.Item) -> Unit) : RecyclerView.Adapter<FacilityViewHolder>() {

  var centers: List<FacilitiesQuery.Item>? = null
  var currentLocation: Location? = null

  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FacilityViewHolder {
    val view = LayoutInflater.from(parent.context).inflate(R.layout.fragment_facility, parent,
        false)
