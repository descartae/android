...
abstract class BaseLocationPresenter protected constructor(
  internal var mFusedLocationClient: FusedLocationProviderClient) : OnSuccessListener<Location> {
  ...
  fun requestLocation() {
    ...
    mFusedLocationClient.requestLocationUpdates(mRequestingLocationUpdates, mLocationCallback,
        null/* Looper */)
