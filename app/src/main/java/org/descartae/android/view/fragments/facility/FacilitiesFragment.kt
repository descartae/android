...
import kotlinx.android.synthetic.main.filter_empty_view.*
import kotlinx.android.synthetic.main.fragment_facility_list.*
...
class FacilitiesFragment : Fragment(), OnMapReadyCallback {
    ...
    @Inject lateinit var presenter: FacilityListPresenter

    @Inject lateinit var presenterTypeWaste: TypeOfWastePresenter
            ...
            R.id.action_filter -> {
                ...
                MaterialDialog.Builder(activity!!)
                        ...
                        .itemsCallbackMultiChoice(selectedTypesIndices, {
                            _, which, _ -> selectedTypesIndices = which
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        activity!!.fragmentManager.beginTransaction().replace(R.id.map, mMapFragment).commitAllowingStateLoss()
        return view
    }
    ...
    private fun fillMapMarkers() {
        ...
        if (facilities != null && facilities.isNotEmpty()) {
            ...
            facilities.forEach { facility ->
                val latlng = LatLng(facility.location().coordinates().latitude(), facility.location().coordinates().longitude())
                mMap!!.addMarker(
                        MarkerOptions()
