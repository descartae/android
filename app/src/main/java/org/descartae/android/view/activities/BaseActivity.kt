...
abstract class BaseActivity : AppCompatActivity(), RequestPermissionView {
    ...
    @Inject lateinit var preferences: DescartaePreferences
    ...
    protected fun init() {
        val permFineLocation = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
        val permCoarseLocation = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
