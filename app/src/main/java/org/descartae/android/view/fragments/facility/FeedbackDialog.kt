...
import kotlinx.android.synthetic.main.dialog_feedback.button_cancel
import kotlinx.android.synthetic.main.dialog_feedback.button_ok
import kotlinx.android.synthetic.main.dialog_feedback.button_send
import kotlinx.android.synthetic.main.dialog_feedback.editText_message
import kotlinx.android.synthetic.main.dialog_feedback.textView_subtitle
import kotlinx.android.synthetic.main.dialog_feedback.textView_title
...
class FeedbackDialog : DialogFragment() {
  ...
  override fun onActivityCreated(savedInstanceState: Bundle?) {
    ...
    button_send.setOnClickListener {
      ...
      if (feedback.isEmpty())
        Snackbar.make(editText_message, R.string.feedback_no_message_error,
