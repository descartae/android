...
import kotlinx.android.synthetic.main.content_home.content
...
class HomeActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener, RetryConnectionView, EmptyRegionUnsupportedFragment.Listener {
  ...
  override fun permissionNotGranted() {
    supportFragmentManager.beginTransaction().replace(R.id.content,
        EmptyLocationPermissionFragment.newInstance()).commitAllowingStateLoss()
  }
  ...
  override fun permissionGranted() {
    ...
    if (gpsEnabled) {
      ...
      if (facilitiesFragment == null || !facilitiesFragment!!.isAdded) {
        ...
        supportFragmentManager.beginTransaction().replace(R.id.content,
            facilitiesFragment).commitAllowingStateLoss()
      }
    } else {
      supportFragmentManager.beginTransaction().replace(R.id.content,
          EmptyGPSOfflineFragment.newInstance()).commitAllowingStateLoss()
    }
  }
    ...
    when (id) {
      R.id.nav_rate -> {
        ...
        val intent = Intent(Intent.ACTION_VIEW,
            Uri.parse(getString(R.string.app_share, BuildConfig.APPLICATION_ID)))
  ...
  override fun showWaitListDialog(latitude: Double, longitude: Double) {
    RegionWaitListDialog.newInstance(latitude, longitude).show(supportFragmentManager,
        "DIALOG_WAIT_LIST")
  }
